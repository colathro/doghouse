...
export const Dice1: React.FC<props> = (props: props) => {
  return (
    <Svg style={props.style} viewBox="0 0 320 320" {...props}>
      <G data-name={1}>
        ...
        <Path
          ...
          fill="#1a1a1a"
        />
        <Circle cx={160} cy={160} r={24.5} fill="#1a1a1a" />
        <Path d="M160 141a19 19 0 11-19 19 19 19 0 0119-19m0-11a30 30 0 1030 30 30 30 0 00-30-30z" />
        <G opacity={0.75} fill="#443f3f" mask="url(#prefix__b)">
          <Circle cx={160} cy={160} r={24.5} fill="#1a1a1a" />
          <Path d="M160 141a19 19 0 11-19 19 19 19 0 0119-19m0-11a30 30 0 1030 30 30 30 0 00-30-30z" />
        </G>
      </G>
