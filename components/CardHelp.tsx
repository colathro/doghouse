...
export const CardHelp: React.FC<props> = (props: props): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      >
        <View style={[styles.helpView, {left: xPage + hWidth, width: width - xPage - hWidth}]}>
          <View style={styles.item}>
            <View style={[styles.balloon, {backgroundColor: '#ffe0cc', minHeight: yPage }]}>
              <Text style={styles.helpText}>{props.help}</Text>
              <View
                style={[styles.arrowContainer, {height: yPage }]}
              >
